namespace LealPassword.Settings
{
    internal static class DefinitionsConstants
    {
        ...
        internal static readonly int ELIPSE_CURVE = 20;
        internal static readonly int SELECTABLE_AREA = 32;
